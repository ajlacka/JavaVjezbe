...
import java.util.ArrayList;
	...
	String displayType = e.getTip().substring(0, 1).toUpperCase() + e.getTip().substring(1);
	...
	if (e.getTip().toLowerCase().contains(queryLower)) {
	...
	Player player = new Player("Pero Perovic", 10, 10, 40, 60, 100);
	...
	Enemy enemy1 = new Enemy("Skubi Doo", 15, 15, 30, 30, 25);
	...
	String enemyData = "Marko;12,5;16x16;30";



	Enemy enemy2 = new Enemy("Goblin",12,5,16,16,20);
